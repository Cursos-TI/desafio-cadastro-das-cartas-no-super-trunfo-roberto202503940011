 ...
 *            - Cálculos de atributos derivados (densidade, PIB per capita, Super Poder)
...
int main() {
    ...
    float densidade_pop1;            // Densidade populacional (hab/km²)
    ...
    float densidade_pop2;            // Densidade populacional (hab/km²)
     ...
     * de forma organizada e legível. Utiliza formatação específica para cada
     * tipo de dado, garantindo apresentação adequada dos valores.
     */
